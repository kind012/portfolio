      ...
      <div className="flex flex-col h-[550px] sticky top-44">
        ...
        >
          <div className="flex flex-col mb-[27px] max-w-[695px] w-full">
            <RevealUp>
              <div className="flex flex-row gap-6 items-center">
                ...
                />
                <h3 className="text-beige-100 lg:text-[56px] text-[32px] font-bold whitespace-nowrap">
                  {card.title}
                </h3>
              </div>
            </RevealUp>
            <div className="max-w-[555px] w-full">
              <RevealUp>
                <p className="text-beige-200 text-2xl font-medium">
                  {card.description}
                </p>
              </RevealUp>
            </div>
          ...
          <div className="flex flex-col gap-y-3 max-w-[695px] w-full pt-6">
            <span className="lg:text-[40px] text-[20px] text-beige-100 font-bold flex flex-row gap-x-3">
              {card.tag}
            </span>
