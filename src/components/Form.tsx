    ...
    <div className="grid grid-cols-1 gap-x-20 md:grid-cols-12">
      ...
      >
        <div className="flex flex-col w-full">
          <label htmlFor="Name" className="text-link mb-1 2xl:mb-2">
            Your Name <span className="text-error-100 pl-[.25rem]">*</span>
          </label>
          <input
            type="text"
            className="rounded-xl max-w-[779px] w-full text-beige-500 text-xl font-semibold px-4 py-3 bg-transparent focus:bg-beige-600  border border-[#2f2f2d]"
            placeholder="Closum"
            id="Name"
            required
            name="Name"
        ...
        <div className="flex flex-col w-full">
          <label htmlFor="Email" className="text-link mb-1 2xl:mb-2">
        ...
        <div className="flex flex-col w-full mb-12">
          <label htmlFor="Message" className="text-link mb-1 2xl:mb-2">
            Message <span className="text-error-100 pl-[.25rem]">*</span>
          </label>
          <textarea
            name="Message"
            id="Message"
            className="pb-20 2xl:pb-32 rounded-xl text-beige-500 text-xl font-semibold px-4 py-3 bg-transparent focus:bg-beige-600  border border-[#2f2f2d]"
            required
      ...
      <aside className="order-[-9999] text-link col-span-1 mb-16 flex w-fit flex-col gap-y-12 sm:col-span-3 md:order-[99999] md:mb-0">
        <div className="flex flex-col gap-y-3 md:gap-y-4">
          <h2 className="font-bold uppercase leading-none text-secondary-300">
          ...
          <div className="flex flex-col gap-y-2">
            <a
              ...
              target="_blank"
              className="text-link font-medium leading-none text-four-600"
            >
              closum@dev.com
            </a>
            <a
