...
const Header = () => {
  return (
    <motion.header
      className="flex flex-row lg:justify-between lg:gap-[9.75rem] gap-2 w-full lg:pt-6 lg:px-[54px] px-6 pt-6"
      initial="hidden"
      animate="visible"
      variants={varients}
    >
      <nav className="flex flex-row justify-between w-full text-lg font-light text-[#ece6d5] items-center">
        <Link to="#">
