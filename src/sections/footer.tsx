  ...
  return (
    <footer className="lg:mx-[75px] mx-3 py-4">
      <div className="flex justify-between items-center">
        <p className="uppercase text-xs lg:text-[15px] text-white font-normal font-NeueMontreal">
          available for freelance
        </p>

        <div className="flex items-center justify-between  gap-1 lg:gap-40">
          <div className="uppercase text-xs lg:text-[15px] text-white font-normal font-NeueMontreal">
            <AnimateLink
              title="facebook"
